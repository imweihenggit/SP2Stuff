	...
	if (move == true)
	{
		...
		if(Application::IsKeyPressed('A'))
		{
			if (Application::IsKeyPressed('D') == 0)
			{
				...
				if (position.x > 988 || position.x <-988 || position.z > 695 || position.z < -988 || (collideA == true && collideD == false))
				{
		...
		if(Application::IsKeyPressed('D'))
		{
			if (Application::IsKeyPressed('A') == 0)
			{
				...
				if (position.x > 988 || position.x <-988 || position.z > 695 || position.z < -988 || (collideD == true && collideA == false))
				{
					if (position.z >= -35 && position.z <= 45 && position.x >= 395 && position.x <= 495) {
					}
		...
		if(Application::IsKeyPressed('W'))
		{
			if (Application::IsKeyPressed('S') == 0)
			{
				...
				if (position.x > 988 || position.x <-988 || position.z > 695 || position.z < -988 || (collideW == true && collideS == false))
				{
					if (position.z >= -35 && position.z <= 45 && position.x >= 395 && position.x <= 495) {
					}
		...
		if(Application::IsKeyPressed('S'))
		{
			if (Application::IsKeyPressed('W') == 0)
			{
				...
				if (position.x > 988 || position.x <-988 || position.z > 695 || position.z < -988 || (collideS == true && collideW == false))
				{
					if (position.z >= -35 && position.z <= 45 && position.x >= 395 && position.x <= 495) {
					}
